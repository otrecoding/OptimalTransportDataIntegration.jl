...
function sample_ratio_effect_continuous(nsimulations::Int, ratios)

    outfile = "sample_ratio_effect_continuous.csv"
...
function sample_ratio_effect_discrete(nsimulations::Int, ratios)

    outfile = "sample_ratio_effect_discrete.csv"
    header = ["id", "nA", "nB", "estyb", "estza", "est", "method", "scenario"]
